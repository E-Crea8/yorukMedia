...
<head>
	...
	<title>Yoruk Media - App Login</title>
        ...
        <?php echo $pass_empty_err; ?>
			...
			<div class="login-form">
				<div class="form-group">
					...
					<input id="username" name="username_signin" type="text" class="form-control" value="<?php if(isset($_COOKIE["username_signin"])) { echo $_COOKIE["username_signin"]; } ?>" required>
				</div>
				<div class="form-group">
